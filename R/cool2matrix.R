...
cool2matrix <- function(cool.path, chr, bin.width = NA, balance = FALSE, balancing_name = "weight", verbose = TRUE, chr2 = NULL) {
  ...
  ###################
  #cool.path = "/work/genphyse/genome3D/Var_struc/Human/4DNFI8ZYY7VT.mcool" #"~/mnt/genome3D/Var_struc/Mouton_onCow/Contact_maps/Distiller_Arima/norm/mcool/mouton8045.ARS-UCD1.2.mapq_10.4000.mcool"
  #chr = "chr1"
  #chr2 = "chr20"
  #bin.width = 500000
  #balance = FALSE; balancing_name = "weight"; verbose = TRUE
  ###################
